...
namespace Lab08_QLSV_SQL.StudentDBDataSetTableAdapters {
...
SELECT MaSo, MaMH, Diem FROM KetQua WHERE (MaMH = @MaMH) AND (MaSo = @MaSo)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = "Data Source=TanQuyen\\SQLEXPRESS;Initial Catalog=StudentDB;Integrated Security=Tru" +
